...
export default {
  ...
  methods: {
        ...
        getUser: function(username){
            ...
            this.email=username
            if(username!=''){
            axios.get("http://localhost:8081/userc/userByUsername/"+username +"/")
               .then(response => {
      ...
      getComments: function(username){
            ...
            if(role=="ROLE_CABINOWNER"){
               ...
               axios.get("http://localhost:8081/evaluations/cabinOwner/"+username +"/")
               .then(response => {
                 ...
                 axios.get("http://localhost:8081/evaluations/boatOwner/"+username +"/")
                 .then(response => {
                       this.comments=response.data
                 ...
                 axios.get("http://localhost:8081/evaluations/instructor/"+username +"/")
                 .then(response => {
                       this.comments=response.data
