<template>
  <div>
    ...
    <ul class="nav justify-content-center" style="background-color: #0b477b">
      <li class="nav-item">
        <a @click="home" style="color: white" class="nav-link active" href="#"
          ><svg
...
export default {
  ...
  methods: {
    ...
    newReservation: function () {
      this.$router.push("/reservation/" + this.email);
    },
    availableQuickReservations: function () {
      this.$router.push("/availableQuickReservations/" + this.email);
    },
