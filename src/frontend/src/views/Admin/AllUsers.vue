<template>
  <div>
    ...
    <ul class="nav justify-content-center" style="background-color: #0b477b;">
      ...
      <li class="nav-item">
      <a  style="color: white;" @click="allUsers()" class="nav-link active" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people" viewBox="0 0 16 16">
