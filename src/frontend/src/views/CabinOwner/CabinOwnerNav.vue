<template>
  <div>
    ...
    <ul class="nav justify-content-center" style="background-color: #0b477b">
      <li class="nav-item">
        <a @click="myCabins" style="color: white" class="nav-link active" href="#"
          ><svg
...
export default ({
  ...
  methods: {
    ...
    viewProfile: function(){
          /*this.$router.clear();
          this.$router.push('http://localhost:8080/cabinOwner/viewProfile/'+ this.$props.username + "/"+ this.$props.username);
           */
