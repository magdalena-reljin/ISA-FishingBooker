...
<div class="tab-content" id="myTabContent">
    ...
    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="conact-tab">
                        ...
                        <tbody>
                            ...
                            <td v-if="(ads1.ownersReportDto.comment==='' || ads1.ownersReportDto.comment==null)" @click="writeAReview(ads1)"><button  type="button" class="btn btn-success">Review</button></td>
