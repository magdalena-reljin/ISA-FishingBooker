...
import  rs.ac.uns.ftn.isa.fisherman.exception.ResourceConflictExeption;
...
public class AuthenticationController {
    ...
    public ResponseEntity<User> addUser(@RequestBody UserRequest userRequest, UriComponentsBuilder ucBuilder) {
        System.out.println("AAAAAAAAAAAAAAAAAAA USAOOOO SAMMMM HEHEHEH");
        System.out.println("Poslao samti  " + userRequest.getEmail() +userRequest.getFirstname());
        User existUser = this.userService.findByEmail(userRequest.getEmail());
        if (existUser != null) {
            throw new ResourceConflictExeption(userRequest.getId(),"Username already exists!");
        }

        User user = this.userService.save(cabinOwnerMapper.UserRequestDTOToCabinOwner(userRequest));
