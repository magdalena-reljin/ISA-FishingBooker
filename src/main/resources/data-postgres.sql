...
/*sifra: 123*/INSERT INTO users (role, id, activation_url, city, country, latitude, longitude, street_and_num, username,rating, enabled, last_name, last_password_reset_date, name, password, phone_num, is_predefined, registration_reason) values ('FISHING INSTRUCTOR',4,null, 'Novi Sad','Serbia',45.267136,19.833549, 'ULICA','fi@gmail.com', 4.5,true, 'Vlasnik','2022-01-04 15:31:53.899','Pecaros','$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra','+3810616789856',null,'Da zaradim malo iako ne znam da pecam.');
